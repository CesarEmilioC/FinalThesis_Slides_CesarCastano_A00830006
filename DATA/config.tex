...
\setbeamertemplate{headline}{%
  \leavevmode%
  \vspace*{1.2ex}% breathing room above the band so ascenders don't clip
  \begin{beamercolorbox}[wd=\paperwidth,ht=2.8ex,dp=1.5ex,sep=4pt,center]{section in head/foot}%
    \strut%
