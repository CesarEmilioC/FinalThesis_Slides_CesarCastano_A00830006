...
\textbf{\color{tecdark}On the labeling problem.} Quality grading is inherently subjective; even moderate label noise puts a hard ceiling on accuracy regardless of architecture~\cite{Frenay2014LabelNoise}. With single-evaluator labels and no $\kappa$/ICC, part of the $\sim$70~pp gap and the near-zero $\rho$ at 80/20 is unmeasured label noise -- closing it is a \emph{data \& labeling} problem.
\end{infoBox}
\end{frame}
