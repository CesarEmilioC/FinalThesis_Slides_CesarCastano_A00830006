...
\textbf{\color{tecdark}On the labeling problem.} Quality grading is inherently subjective; even moderate label noise caps accuracy regardless of architecture~\cite{Frenay2014LabelNoise}. With single-evaluator labels and no $\kappa$/ICC, part of the $\sim$70~pp gap is unmeasured noise -- closing it is a \emph{data \& labeling} problem.
\end{infoBox}
\end{frame}
