...
Absolute difference between two percentages: $29.9\%\!\to\!36.1\%$ is a gain of $6.2$~pp, not a $20\%$ relative increase.
\end{description}
\end{frame}

% -----------------------------------------------------------------------------
%  Final closing frame -- Tec de Monterrey logo.
%  Last slide of the entire document (per advisor 24 May 2026), shown after
%  the appendix. The matching frame was removed from references.tex.
% -----------------------------------------------------------------------------
\begin{frame}[plain]
\centering
\vspace*{\fill}
\includegraphics[width=0.55\linewidth,keepaspectratio]{./DATA/FIGS/Logo.pdf}\\[24pt]
{\large\color{tecdark}Tecnol\'ogico de Monterrey}\\[4pt]
{\small\color{slidegray}\itshape Maestr\'ia en Ciencias Computacionales}\\[2pt]
{\small\color{slidegray}\itshape Escuela de Ingenier\'ia y Ciencias}
\vspace*{\fill}
\end{frame}
