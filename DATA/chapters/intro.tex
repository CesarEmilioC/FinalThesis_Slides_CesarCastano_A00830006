...
\begin{enumerate}\small
    ...
    \item Comparative evaluation of three temporal models -- \alert{BiLSTM~\cite{Hochreiter1997LSTM}, BiGRU~\cite{Cho2014GRU}, TCN~\cite{Lea2017TCN}} -- under identical pipeline, dataset, and metrics.
