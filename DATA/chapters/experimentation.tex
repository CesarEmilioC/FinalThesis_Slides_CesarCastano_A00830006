...
\scriptsize Same architecture, same labels, same hyperparameters.\\
Only the train/test fraction changed.\\[1pt]
\[
...
\vspace{2pt}
\begin{itemize}\scriptsize
    \item Flat performance across splits would mean architecture/pipeline is the binding constraint -- ours is not flat.
