...
{\scriptsize\textbf{Figure 10.} \itshape Per-cell val-loss curves; MSE and XEnt sit on different numerical scales (not directly comparable). Ranking by test accuracy is in Table~5 -- winner: \alert{XEnt\,+\,SGD at 35.1\%}.}
\end{column}
\end{columns}
\end{frame}
