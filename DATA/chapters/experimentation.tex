...
\centering
\includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{./DATA/images/experimentation/split_confusion_06.pdf}\\[2pt]
...
Only the train/test fraction changed.\\[2pt]
\[
...
\begin{itemize}\small
    ...
    \scriptsize\,(ii) strengthen L2 / dropout,\\
    \scriptsize\,(iii) adopt XEnt + SGD.
\end{itemize}
\end{column}
\end{columns}
\end{frame}
