...
\footnotesize
\begin{center}
\textbf{Table 3.} \itshape BiLSTM stage progression on 80/20 stratified split (seed 42).\\[1pt]
\upshape
...
\scriptsize Same architecture, same labels, same hyperparameters -- only the train/test fraction changed.\\[2pt]
\centerline{$29.9\%\;\Longrightarrow\;\textbf{36.1\%},\quad \rho\!:\;0.03\!\rightarrow\!\textbf{0.23},\quad p\!:\;0.76\!\rightarrow\!\textbf{0.001}$}\\[2pt]
\textit{pp = percentage points: absolute difference between two percentages ($36.1-29.9=6.2$).}
\end{alertblock}
\vspace{2pt}
\begin{itemize}\scriptsize
