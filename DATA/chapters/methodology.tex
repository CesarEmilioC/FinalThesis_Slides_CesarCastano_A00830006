...
\centering
\includegraphics[width=\linewidth]{./DATA/images/experimentation/label_distribution.pdf}\\[2pt]
...
\centering
\includegraphics[width=0.92\linewidth,height=0.5\textheight,keepaspectratio]{./DATA/images/experimentation/dataset_mosaic.pdf}\\[6pt]
...
\begin{column}{0.46\textwidth}
\centering
\includegraphics[width=\linewidth]{./DATA/images/methodology/poseEstimation_Example.pdf}\\[2pt]
...
\addlinespace[2pt]
\textbf{TCN}~\cite{Lea2017TCN}    & 3 dilated 1-D convs (kernel 3, dilation 1/2/4) + GAP & Parallel processing, fixed receptive field \\
\bottomrule
\end{tabular}
\end{center}
\vspace{4pt}
...
\begin{itemize}\small
    ...
    \item Adam~\cite{Adam2014}, sparse categorical cross-entropy, batch size 16, 100 epochs.
...
\small
For a $K$-class problem, with $\text{TP}_c, \text{FP}_c, \text{FN}_c$ per class~$c$:
\vspace{2pt}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.5\textwidth}
\begin{block}{Per-class}
\small
\[
...
\]
\[
\text{Accuracy} \;=\; \frac{\sum_c \text{TP}_c}{N}
\]
\end{block}
\end{column}
\end{columns}
