...
{\scriptsize\itshape \textbf{One of the 8 columns:} wrist trajectory across the 90 frames, same player. \alert{Excellent} (g.\,9): smooth arc ($\sigma\!=\!40.1$~px). \alert{Very Low} (g.\,1): irregular ($\sigma\!=\!184.1$~px). The other 7 columns evolve in parallel.}
\end{column}
