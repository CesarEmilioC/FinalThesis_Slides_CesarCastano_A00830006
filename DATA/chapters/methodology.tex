...
\begin{frame}[label=sub:pipeline]{End-to-end pipeline}
\centering
...
\begin{frame}[label=sub:dataset]{Data collection \& labeling}
...
\begin{frame}[label=sub:pose]{Pose estimation with OpenPose}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
...
\begin{frame}[label=sub:models]{Three temporal architectures}
...
\begin{frame}[label=sub:metrics]{Evaluation metrics -- categorical}
\small
